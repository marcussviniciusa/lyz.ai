...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Apenas superadmin vê configurações
  if (session?.user?.role === 'superadmin') {
    navigation.push(
      { name: 'Config. IA Global', href: '/settings/global-ai', icon: 'brain', current: pathname.startsWith('/settings/global-ai') },
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed top-0 left-0 z-50 w-64 h-full bg-white shadow-lg">
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
            <img src="/logo.png" alt="Lyz.ai" className="h-8 w-auto" />
            <button
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={`${
                  ...
                  item.current ? 'border-primary-500' : 'border-transparent'
                }`}
                onClick={() => setSidebarOpen(false)}
              >
                {getIcon(item.icon)}
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white pt-5 pb-4 overflow-y-auto border-r border-gray-200">
          <div className="flex items-center flex-shrink-0 px-4">
            <img src="/logo.png" alt="Lyz.ai" className="h-8 w-auto" />
            <span className="ml-2 text-xl font-bold text-primary-900">Lyz.ai</span>
          </div>
          ...
          <div className="flex-1 px-4 flex justify-between">
              ...
              <div className="w-full flex md:ml-0">
                ...
                <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                  ...
                  <input
                    ...
                    placeholder="Buscar pacientes, análises..."
                    type="search"
                  />
                </div>
              </div>
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <button className="bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                ...
                <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM11 3H6a2 2 0 00-2 2v5l2 2h5V8a5 5 0 016 5v6a2 2 0 01-2 2h-5" />
                </svg>
              </button>
